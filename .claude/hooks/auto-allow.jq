...
#   cmd   := (yarn_test | yarn_lint | yarn_tsc | rg_log) tail?
#   tail  := redir_template | pipe_head_tail
...
def cmd_re:
  ...
  + "|(?:rg|grep)\(grep_like_flags_re) \(grep_like_pattern_re)(?: \(log_path_re))+"
  + ")\(output_tail_re)";
